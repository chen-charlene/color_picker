...
// method to map the rgb value to a scaled number that accurately reflects the color value between 0-255
// input: x, input low, input high, output low, output high | output: mapped rgb value
...
// input: r, g, b values | output: vector of calibrated r, g, b values
...
// input: savedColors list, color to be added | output: NA
static int head = 0;
static int tail = 0;
...
// Convert the unit16_t format to a readable RGB value and reassigns the value to the r, g, b pointers
// input: hex rgb, r, g, b values | output: NA
...
// input: r, g, b, values and opacity | output: adjusted r, g, b values stored in a struct
...
// input: r, g, b values | output: hex code for the color
...
// input: potetiometer value | output: opacity value between 0-1
float calculateOpacity(int potVal) {
  ...
  // input: savedColors list| output: NA
  ...
  // input: NA | output: potentiometer reading
  ...
  // input: NA | output: raw r,g,b values
