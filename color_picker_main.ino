...
// main loop that gets called and it executes the main logic of the code. If running tests, the logic section will
// be commented out in exchange for the testing portion
void loop() {
...
// input: currState, mils | output: nextState
